...
AP242_PMI_ENTITY_SUPPORT = {
    ...
    "GEOMETRIC_TOLERANCE_WITH_MODIFIERS": (PARTIAL, "Profile all-over, MMC/LMC material modifiers, and projected-zone definitions export; unequal-disposition export remains future work."),
